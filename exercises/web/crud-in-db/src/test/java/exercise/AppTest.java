...
class AppTest {
    ...
    void testCreateArticle() throws IOException, ParseException, SQLException {
        ...
        HttpEntity entity = response.getEntity();
        String content = EntityUtils.toString(entity);
        assertThat(content).contains("Article successfully created");
    ...
    void testUpdateArticle() throws IOException, ParseException, SQLException {
        ...
        HttpEntity entity = response.getEntity();
        String content = EntityUtils.toString(entity);
        assertThat(content).contains("Article successfully edited");
    ...
    void testDestroyArticle() throws IOException, ParseException, SQLException {
        ...
        HttpEntity entity = response.getEntity();
        String content = EntityUtils.toString(entity);
        assertThat(content).contains("Article successfully deleted");
    ...
    @AfterAll
    public static void tearDown() throws LifecycleException, SQLException {
        connection.close();
        app.stop();
    }
}
